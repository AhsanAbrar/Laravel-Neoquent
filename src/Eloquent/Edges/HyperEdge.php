<?php namespace Ahsan\Neoquent\Eloquent\Edges;

use Ahsan\Neoquent\Eloquent\Model;
use Ahsan\Neoquent\Eloquent\Builder;
use Ahsan\Neoquent\Eloquent\Edges\Relation;
...
class HyperEdge extends Relation {
     ...
     *
     * @var \Ahsan\Neoquent\Eloquent\Model
     */
    protected $morph;
     ...
     *
     * @var \Ahsan\Neoquent\Eloquent\Edges\EdgeOut
     */
    protected $left;
     ...
     *
     * @param Ahsan\Neoquent\Eloquent\Builder $query
     * @param Ahsan\Neoquent\Eloquent\Model   $parent
     * @param string  $type
     * @param Ahsan\Neoquent\Eloquent\Model   $related
     * @param string  $morphType
     * @param Ahsan\Neoquent\Eloquent\Model   $morph
     */
     ...
     * @return void
     *
     * @throws  \Ahsan\Neoquent\NoEdgeDirectionException If $direction is not set on the inheriting relation.
     */
     ...
     *
     * @return \Ahsan\Neoquent\Eloquent\Edges\EdgeOut
     */
     ...
     *
     * @param \Ahsan\Neoquent\Eloquent\Edges\Relation $left
     * @return  void
     */
     ...
     *
     * @param \Ahsan\Neoquent\Eloquent\Edges\Relation $right
     * @return void
     */
     ...
     *
     * @return \Ahsan\Neoquent\Eloquent\Model
     */
