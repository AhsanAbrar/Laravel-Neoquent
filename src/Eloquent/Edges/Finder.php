...
class Finder extends Delegate {
     ...
     *
     * @param  \Ahsan\Neoquent\Eloquent\Model  $parentModel
     * @param  \Ahsan\Neoquent\Eloquent\Model  $relatedModel
     ...
     * @param  \Ahsan\Neoquent\Eloquent\Model  $relatedModel
     * @param  string $direction
     * @return \Ahsan\Neoquent\Eloquent\Edges\Edge[In|Out]|null
     */
     ...
     * @return \Ahsan\Neoquent\Eloquent\Edges\HyperEdge
     */
     ...
     * @param  \Everyman\Neo4j\Relationship $relation
     * @param  string $direction
     * @return \Ahsan\Neoquent\Eloquent\Edges\Edge[In|Out]
     */
