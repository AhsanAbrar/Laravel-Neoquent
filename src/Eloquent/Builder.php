...
class Builder extends IlluminateBuilder {
     ...
     *
     * @param  \Ahsan\Neoquent\Eloquent\Model $parent       The parent model
     * @param  \Ahsan\Neoquent\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \Ahsan\Neoquent\Query\Builder|static
     */
     ...
     * @param  \Ahsan\Neoquent\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \Ahsan\Neoquent\Eloquent|static
     */
     ...
     *
     * @param string $holder
     * @param \Ahsan\Neoquent\Eloquent\Model|string  $model String in the case of morphs where we do not know
     ...
     *
     * @param  \Ahsan\Neoquent\Eloquent\Relations\* $relation
     * @return [type]
     */
