<?php namespace Ahsan\Neoquent\Eloquent;
...
use Ahsan\Neoquent\Eloquent\Relations\MorphTo;
use Ahsan\Neoquent\Eloquent\Relations\BelongsTo;
use Ahsan\Neoquent\Eloquent\Relations\MorphMany;
use Ahsan\Neoquent\Eloquent\Relations\HyperMorph;
use Ahsan\Neoquent\Eloquent\Relations\OneRelation;
use Ahsan\Neoquent\Query\Builder as QueryBuilder;
use Ahsan\Neoquent\Eloquent\Relations\MorphedByOne;
use Ahsan\Neoquent\Eloquent\Relations\BelongsToMany;
use Illuminate\Database\Eloquent\Model as IlluminateModel;
use Ahsan\Neoquent\Eloquent\Builder as EloquentBuilder;
...
abstract class Model extends IlluminateModel {
     ...
     *
     * @param  \Ahsan\Neoquent\Query\Builder $query
     * @return \Ahsan\Neoquent\Eloquent\Builder|static
     */
     ...
     *
     * @return \Ahsan\Neoquent\Query\Builder
     */
    ...
    public function getDefaultNodeLabel()
    {
        ...
        return array(str_replace('App\\', '', get_class($this)));
    }
     ...
     * @param  string  $type
     * @param  string  $key
     * @return \Ahsan\Neoquent\Eloquent\Relations\HasMany
     */
     ...
     * @param  string  $ownerKey
     * @param  string  $relation
     * @return \Ahsan\Neoquent\Eloquent\Relations\BelongsToMany
     */
    ...
    {
        // To escape the error:
        // PHP Strict standards:  Declaration of Ahsan\Neoquent\Eloquent\Model::belongsToMany() should be
     ...
     *
     * @param  \Ahsan\Neoquent\Eloquent\Model  $model
     * @param  string $related
     * @param  string $type
     * @param  string $morphType
     * @param  string $relation
     * @param  string $key
     * @return \Ahsan\Neoquent\Eloquent\Relations\HyperMorph
     */
     ...
     * @return \Ahsan\Neoquent\Eloquent\Relations\MorphMany
     */
    public function morphMany($related, $name, $type = null, $id = null, $localKey = null)
    {
        // To escape the error:
        // Strict standards: Declaration of Ahsan\Neoquent\Eloquent\Model::morphMany() should be
     ...
     *
     * @param  \Ahsan\Neoquent\Eloquent\Model $related
     * @param  string $type
     * @param  string $key
     * @param  string $relation
     * @return \Ahsan\Neoquent\Eloquent\Relations\MorphedByOne
     */
